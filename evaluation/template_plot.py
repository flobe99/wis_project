...
def four_rooms_2_samples_reward_b_8_complexity_12():
    data = get_data("four_rooms_2_samples_reward_b_8_complexity_12.csv")

    line_plot_samples_reward("four rooms samples reward with and space complexity 12x12", data)


def four_rooms_2_samples_reward_b_8_complexity_24():
    data = get_data("four_rooms_2_samples_reward_b_8_complexity_24.csv")

    line_plot_samples_reward("four rooms samples reward with and space complexity 24x24", data)


def four_rooms_2_samples_reward_b_8_complexity_36():
    data = get_data("four_rooms_2_samples_reward_b_8_complexity_36.csv")
